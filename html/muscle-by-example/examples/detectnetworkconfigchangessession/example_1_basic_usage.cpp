...
int main(int argc, char ** argv)
{
   ...
   if (reflectServer.AddNewSession(AbstractReflectSessionRef(&myDetectSession, false)) != B_NO_ERROR)
   {
      LogTime(MUSCLE_LOG_ERROR, "Couldn't add MyDetectNetworkConfigChangesSession, aborting!\n");
      return 10;
   }
